...
public class SM2X509CertMaker {
    ...
    public SM2X509CertMaker(KeyPair issuerKeyPair, X500Name issuer,
                            CertSNAllocator snAllocator) {
        this.issuerKeyPair = issuerKeyPair;
        this.issuerDN = issuer;
        this.snAllocator = snAllocator;
    ...
    public X509Certificate makeCertificate(BigInteger certNo,long notBefore, long notAfter, KeyUsage keyUsage, X500Name subject, PublicKey subPub)
            throws Exception {

        JcaX509ExtensionUtils extUtils = new JcaX509ExtensionUtils();
        X509v3CertificateBuilder v3CertGen = new JcaX509v3CertificateBuilder(issuerDN, certNo,
    ...
    public X509Certificate makeCertificate(long notBefore, long notAfter, KeyUsage keyUsage, X500Name subject, PublicKey subPub)
            throws Exception {
        return makeCertificate(snAllocator.nextSerialNumber(),notBefore,notAfter,keyUsage,subject,subPub);
    }
