...
public class SM2CertUtil {
    ...
    public static X509CertificateHolder toBcCert(X509Certificate certificate) throws CertificateEncodingException, IOException {
        X509CertificateHolder bcInstance = new X509CertificateHolder(certificate.getEncoded());
       return bcInstance;
    }
}
